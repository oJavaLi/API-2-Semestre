...
public class HoraExtra extends JFrame {
	...
	public HoraExtra() {
		...
		JLabel lblNewLabel_1 = new JLabel("APONTAMENTOS HORA EXTRA");
		...
		lblNewLabel_2_2.setBounds(40, 190, 27, 21);
		contentPane.add(lblNewLabel_2_2);
		
		Label label_2 = new Label("Cliente:");
		label_2.setFont(new Font("Roboto", Font.PLAIN, 14));
		label_2.setBounds(64, 190, 201, 21);
		contentPane.add(label_2);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(36, 214, 235, 32);
		...
		textArea.setBounds(36, 449, 734, 134);
